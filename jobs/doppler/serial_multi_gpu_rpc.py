...
base_save_path = os.path.join(base, "serial_multi_gpu_rpc")
...
devices = {
    "2": ["unimachine:2080.0", "unimachine:2080.1"],
    "3": ["unimachine:2080.0", "unimachine:2080.1", "unimachine:2080.2"],
    "4": ["unimachine:2080.0", "unimachine:2080.1", "unimachine:2080.2", "unimachine:2080.3"],
}
