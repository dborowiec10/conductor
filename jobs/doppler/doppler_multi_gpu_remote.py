...
base_save_path = os.path.join(base, "doppler_multi_gpu_remote")
...
devices = {
    "2": ["unimachine.2080.0", "unimachine2.2080.0"],
    "3": ["unimachine.2080.0", "unimachine2.2080.0", "unimachine3.2080.0"],
    "4": ["unimachine.2080.0", "unimachine2.2080.0", "unimachine3.2080.0", "unimachine3.2080.0"],
}
...
platform = "amd2080"
dop = "doppler"
approach = "doppler_mutli_gpu_remote"

def generate_multi_gpu_remote():
