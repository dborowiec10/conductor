...
"""
import tvm
from conductor.component.method.flex.utils import assert_print
...
def _ShiftConv2d_nhwc(Input, Kernel, dilation, stride):
    ...
    PInput = tvm.topi.nn.pad(Input, (0, padding[0], padding[1], 0),
                            (0, padding[0], padding[1], 0), name="PInput")

    # argmax(data, axis=None, keepdims=False): tvm.topi argmax function
    kernelIndex = tvm.topi.argmax(Kernel, axis=(1, 2))
