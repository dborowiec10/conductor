...
logger = logging.getLogger("conductor.component.measurer.doppler_multi_estimator_no_update")

class DopplerMultiEstimatorNoUpdateMeasurer(DopplerBaseMeasurer):
    _name = "doppler_multi_estimator_no_update"
    
    def __repr__(self):
        return DopplerBaseMeasurer.__repr__(self) + ":" + DopplerMultiEstimatorNoUpdateMeasurer._name

    def __init__(self, builder, runner, configs={}, child_default_configs={}):
        DopplerBaseMeasurer.__init__(self, "doppler_multi_estimator_no_update", builder, runner, configs=configs, child_default_configs=Configurable.merge_configs({
            "max_dop": 64,
            "window_deltas": 2,
            "window_times": 2,
