...
logger = logging.getLogger("conductor.component.measurer.doppler_estimator")

class DopplerEstimatorMeasurer(DopplerBaseMeasurer):
    _name = "doppler_estimator"
    
    def __repr__(self):
        return DopplerBaseMeasurer.__repr__(self) + ":" + DopplerEstimatorMeasurer._name

    def __init__(self, builder, runner, configs=None, child_default_configs={}):
        DopplerBaseMeasurer.__init__(self, "doppler_estimator", builder, runner, configs=configs, child_default_configs=Configurable.merge_configs({
            "max_dop": 64,
            "window_deltas": 2,
            "window_times": 2,
